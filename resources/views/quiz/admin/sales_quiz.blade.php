                                                ...
                                                <tr>
                                                    <!-- <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                        <p class="text-gray-600 whitespace-no-wrap">
                                                            {{ (($quiz->項目 == 'PJ適性') ? 1 : (($quiz->項目 == 'コミュニケーション')
                                                            ? 2 : 3)) }}
                                                        </p>
                                                    </td> -->
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                    ...
                                                                    <form method="POST" action="{{ route('update.quiz') }}">
                                                                        ...
                                                                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                                            ...
                                                                            <select id="項目" name="項目"
                                                                                class="w-full bg-gray-100 p-2 mt-2 mb-3">
                                                                                <option selected></option>
                                                                                <option value="PJ適性" {{$quiz->項目 == 'PJ適性' ? 'selected' : ''}}>PJ適性</option>
                                                                                <option value="コミュニケーション" {{$quiz->項目 == 'コミュニケーション' ? 'selected' : ''}}>コミュニケーション</option>
                                                                                <option value="リーダー適性" {{$quiz->項目 == 'リーダー適性' ? 'selected' : ''}}>リーダー適性</option>
                                                                            </select>
                                                                            <label>No</label>
                                                                        ...
                                                                        <div class="bg-gray-200 px-4 py-3 text-right">
                                                                            <button type="button"
                                                                                class="py-2 px-4 bg-gray-500 text-white rounded hover:bg-gray-700 mr-2"
                                                                                onclick="toggleEdit({{ $quiz->id }})"><i class="fas fa-times"></i>
                                                                                キャンセル</button>
                                                                            <button type="submit"
                                                                                class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-700 mr-2"><i
                                                                                    class="fas fa-plus"></i> 質問編集</button>
                                                                        </div>
                                                                        <input type="hidden" name="level" value="sales">
                                                                        <input type="hidden" name="id" value="{{ $quiz->id }}">
                                                                    </form>
