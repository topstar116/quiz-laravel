        ...
        <ul class="font-medium px-4 text-left">
            <li class="text-gray-100">
                ...
                <a href="{{ route('admin.quiz.resuming') }}"><button href="#resuming" v-on:click="select('resuming')"
                        class="rounded text-sm block py-3 px-6 {{ $page == 'resumingQuiz' ? '' : 'hover:' }}bg-blue-600 w-full text-left">職種適性</button></a>
        ...
        <ul class="font-medium px-4 text-left">
            <li class="text-gray-100">
                ...
                <a href="{{ route('admin.result.resuming') }}"><button href="#resuming_result"
                        ...
                        class="rounded text-sm block py-3 px-6 {{ $page == 'resumingResult' ? '' : 'hover:' }}bg-blue-600 w-full text-left">職種適性</button></a>
